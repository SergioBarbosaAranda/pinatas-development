class SubTypesController < ApplicationController
  before_action :set_sub_type, only: [:show, :edit, :update]
  before_action :authenticate_admin!
  before_action :set_types, only: [:new, :show, :edit, :update]
  ...
  private
    ...
    def sub_type_params
      params.require(:sub_type).permit(:name, :description, :type_of_article_id)
    end
end
