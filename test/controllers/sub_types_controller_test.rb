...
class SubTypesControllerTest < ActionController::TestCase
  ...
  test "should create sub_type" do
    assert_difference('SubType.count') do
      post :create, sub_type: { description: @sub_type.description, name: @sub_type.name, type_of_article_id: @sub_type.type_of_article_id }
    end
  ...
  test "should update sub_type" do
    patch :update, id: @sub_type, sub_type: { description: @sub_type.description, name: @sub_type.name, type_of_article_id: @sub_type.type_of_article_id }
    assert_redirected_to sub_type_path(assigns(:sub_type))
  end
